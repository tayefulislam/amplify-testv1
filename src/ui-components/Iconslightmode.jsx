...
export default function Iconslightmode(props) {
  ...
  return (
    <Icon
      ...
      {...rest}
      {...getOverrideProps(overrides, "Iconslightmode")}
    ></Icon>
  );
}
